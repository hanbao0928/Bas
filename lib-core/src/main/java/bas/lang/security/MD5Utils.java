...
public class MD5Utils {
     ...
     * @return true:校验通过
     */
    public static boolean equals(@NotNull String message, @NotNull String md5) throws NoSuchAlgorithmException {
     ...
     * @return true:校验通过
     */
    public static boolean equals(@NotNull String message, @NotNull String salt, @NotNull String md5) throws NoSuchAlgorithmException {
