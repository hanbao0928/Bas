package bas.leanback.effect.compiler;
...
import bas.lib.compiler.DroidParamUtils;
...
public class EffectLayoutProcessor extends BaseProcessor {
    ...
    private static final String PACKAGE_NAME = "bas.leanback.effect";
    ...
    private void generateMethods(TypeSpec.Builder typeBuilder, String clazz) {
        ...
        MethodSpec extraConstructor = MethodSpec.constructorBuilder()
                ...
                .addParameter(ClassName.get(PACKAGE_NAME, "EffectParams").annotated(AnnotationUtils.nonNullAnnotation), "effectParams")
    ...
    private void draw(TypeSpec.Builder typeBuilder, String clazz) {
        MethodSpec draw = MethodSpec.methodBuilder("draw")
                .addAnnotation(AnnotationUtils.createMissingSuperCallAnnotation())
                .addAnnotation(Override.class)
                .addModifiers(Modifier.PUBLIC)
                .addParameter(DroidParamUtils.canvasTypeName(true), "canvas")
                .addStatement("assert canvas != null")
