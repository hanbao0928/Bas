...
import bas.droid.systemui.applyImmersiveStatusBar
import bas.droid.systemui.applyStatusBarColor
import bas.droid.systemui.applyStatusBarLightMode

/**
 * 用于装载Fragment的Activity容器，包含PigActivity所有功能特性
 *
 */
class FragmentContainerActivity : AMActivity<AMViewModel>() {
